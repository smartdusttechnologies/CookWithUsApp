...
export default function NavBar({ setRole }) {
    ...
    //try {
    //    const token = localStorage.getItem('jwtToken'); // Or however you store the token

    //    if (token && !isTokenExpired(token)) {
    //        const decodedToken = jwtDecode(token);
    //        console.log('User Details:', decodedToken);

    //        const userId = decodedToken.sub;  // Example: userId might be in the 'sub' claim
    //        const username = decodedToken.name; // Example: username in 'name' claim
    //        // Access other claims as needed
    //    } else {
    //        console.log('No token found or token has expired');
    //    }
    //} catch (error) {
            ...
            />
                ...
                <header class="_76q0O">
                    <div class="global-nav">
                        <div class="_1EuBh">
                            <a href="/" class="d9y3g" title="Swiggy"></a>
                            <div role="button" class="_2z2N5" tabindex="0">
                                <span class="_1tcx6 _34oCb"> <span class="_3odgy">Work</span></span
                                ><span class="_3HusE"
                                >Chhoti Badalpura, Bihar 801105, India (Khagaul)</span
                                >
                                <span class="icon-downArrow kVKTT"></span>
                            </div>
                            <ul class="_1JNGZ">
                                <li class="_1fo6c" onClick={falseLogin }>
                                    <div class="_1fmVk _30y3a">
                                        <div>
                                            <div class="_2CgXb">
                                                <div class="_1T-E4"><span>Log Out</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="_1fo6c">
                                    <div class="_1fmVk _30y3a">
                                        <div>
                                            <div class="_2CgXb">
                                                <a class="_1T-E4" href="/my-account">
                                                    <span class="_3yZyp"></span>
                                                    {userDetails && (
                                                        <span className="_1qbcC">
                                                            {userDetails.name}
                                                        </span>
                                                    )}
                                                </a>
                                ...
                                <li class="_1fo6c">
                                    <div class="_2CgXb">
                                        ...
                                        ><span class="_3yZyp"></span>Offers<span class="PJaej"
                                        >NEW</span
                                            ></a
                                        >
                                    </div>
                                ...
                                <li class="_1fo6c">
                                    <div class="_2CgXb">
                                        ...
                                        ><span class="_3yZyp"> </span><span>Search</span></a
                                        >
                                    </div>
                                </li>
                            </ul>
                ...
                <>
                    <header className="_76q0O">
                        <div className="global-nav">
                            <div className="_1EuBh">
                                <a href="/" className="d9y3g" title="Cook With Us"
                                ><svg
                                    className="_8pSp-"
                                    viewBox="0 0 559 825"
                                    height="49"
                                ...
                                >
                                    ...
                                    ></a>
                                <div role="button" className="_2z2N5" tabindex="0">
                                    <span className="_1tcx6"><span className="_3odgy">Other</span></span
                                    ><span className="_3HusE"></span><span className="icon-downArrow kVKTT"></span>
                                </div>
                                <ul className="_1JNGZ">
                                    <li className="_1fo6c">
                                                ...
                                                <div className="_2CgXb">
                                                    ...
                                                    >
                                                                <path
                                                                    d="M4.438 0l-2.598 5.11-1.84 26.124h34.909l-1.906-26.124-2.597-5.11z"
                                                                ></path></svg
                                                            ><span className="_2vS77">0</span></span
                                                        ><span>Cart</span></a
                                                    >
                                                </div>
                                            </div>
                                    ...
                                    <li className="_1fo6c">
                                        <div onClick={() => setOpenLogin(true)} className="_2CgXb">
                                            <span className="_3yZyp"
                                            ><svg
                                                className="_1GTCc"
                                                viewBox="6 0 12 24"
                                    ...
                                    {/*                    ></path></svg></span*/}
                                    {/*            >Offers<span className="PJaej">NEW</span></a*/}
                                    {/*        >*/}
                                    {/*    </div>*/}
                                    {/*</li>*/}
                                    <li className="_1fo6c">
                                    ...
                                    <li className="_1fo6c">
                                        <div className="_2CgXb">
                                            <div onClick={() => setRole("Rider")} className="_1T-E4" href="/support"
                                            ><span className="_3yZyp"
                                            ><svg
                                                className="_1GTCc"
                                                viewBox="6 -1 12 25"
                                    ...
                                    <li className="_1fo6c">
                                        <div className="_2CgXb">
                                            <div onClick={() => setRole("Restaurant")} className="_1T-E4" href="/about-us" target="_blank"
                                            ><span className="_3yZyp"
                                            ><svg
                                                className="_1GTCc"
                                                viewBox="0 0 20 20"
                    ...
                    {openLogin &&
                        <>
                            <UserLogin setOpenSignUp={setOpenSignUp} setOpenLogin={setOpenLogin} />
                        </>
                    }
                    {openSignUp &&
                        <>
                            <UserSignUp setOpenSignUp={setOpenSignUp} setOpenLogin={setOpenLogin} />
                        </>
                    }
                </>
            )}
