...
import "./PhoneMyAccount.css";
export default function PhoneMyAccount() {
    useEffect(() => {
                ...
                <div className="_3AFC5">
                    <div className="_1bhn9">
                        ...
                        <div>
                            <div className="NeDfT">
                                ...
                                <div className="NeDfT" data-testid="swiggy-super-menu-item">
                                    <a className="Ripple_container__17nxL _1ra1j styles_container__1KzFz" href="/">
                                        <div className="styles_content__2JtQA">
                                                ...
                                                <div>
                                                    <div className="_1ZxGJ">
                                                        <div className="VZbKR">
                                                            ...
                                                            />
                                                            <span className="xnEFC" style={{color:"black"} }>Swiggy One</span>
                                                        </div>
                                                        <span className="z_OXN _26nw5">Buy Now</span>
                                                    </div>
                                                    <div className="_2ovU_">
                                                        Unlock 10 Free Deliveries on Food &amp; 10 on Instamart. Buy One Lite
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="NeDfT" data-testid="help-my-account-tab">
                                    <a className="Ripple_container__17nxL _1ra1j styles_container__1KzFz" href="/">
                                        <div className="styles_content__2JtQA">
                                            <div className="_2Jnkx">
                                                <div>
                                                    <div style={{ color: "black" }} className="_1ZxGJ">Help</div>
                        ...
                        <section data-testid="account-logout-options-tab" className="_2N4la">
                            <div>
                                <a className="Ripple_container__17nxL _1q4Zi styles_container__1KzFz" href="/">
                                    <div className="styles_content__2JtQA" style={{ color: "black" }}>Logout Options</div>
                                    <span className="icon-downArrow styles_icon__1L0c1"></span>
                                </a>
                            </div>
                        </section>
                        <section className="_2N4la">
                            <div className="_1ufNE">
                                <button className="_1ufNE" data-testid="account-app-version">
                                    App version v2.71.63-mweb
                                </button>
                            </div>
                        </section>
                    </div>
                    ...
                    <div className="_3JaG6">
                        <div role="navigation" id="bottomNav" tabIndex="0" className="styles_container__2zNtT">
                            <button className="styles_navItem__1wod5" data-testid="bottom-nav-home" aria-label="Double tap to go to Homepage.">
                                <span className="styles_icon__25etV icon-swgyInverse" aria-hidden="true"></span>
                                <span className="styles_icon__25etV styles_iconSelected__tDEZK icon-swgy" aria-hidden="true"></span>
                                <span aria-hidden="true">Swiggy</span>
                            </button>
                            <button className="styles_navItem__1wod5" data-testid="bottom-nav-food" aria-label="Double tap to go to Restaurant's page.">
                                <span className="styles_icon__25etV icon-food" aria-hidden="true"></span>
                                <span className="styles_icon__25etV styles_iconSelected__tDEZK icon-food-selected" aria-hidden="true"></span>
                                <span aria-hidden="true">Food</span>
                            </button>
                            <button className="styles_navItem__1wod5" data-testid="bottom-nav-genie" aria-label="Double tap to go to Genie page.">
                                <span className="styles_icon__25etV icon-genie" aria-hidden="true"></span>
                                <span className="styles_icon__25etV styles_iconSelected__tDEZK icon-genie" aria-hidden="true"></span>
                                <span aria-hidden="true">Genie</span>
                            </button>
                            <button className="styles_navItem__1wod5" data-testid="bottom-nav-search" aria-label="Double tap to go to search page.">
                                <span className="styles_icon__25etV icon-SearchInverse-v3" aria-hidden="true"></span>
                                <span className="styles_icon__25etV styles_iconSelected__tDEZK icon-SearchFilled-v3" aria-hidden="true"></span>
