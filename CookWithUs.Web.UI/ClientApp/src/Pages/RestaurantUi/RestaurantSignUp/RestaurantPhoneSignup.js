...
export default function RestaurantPhoneSignup({ setSignUp }) {
    useEffect(() => {
    ...
    const renderStepDetails = () => {
        if (filledStep === 'info') {
            return (
                    <>
                        <section className="_8PhoneRestaurantSignUp-step">
                                    <h2 className="_8PhoneRestaurantSignUp-subtitle">Step 1: Restaurant Info</h2>

                        <>
                            <div className="_8PhoneRestaurantSignUp-inputGroup">
                                <h3 className="_8PhoneRestaurantSignUp-subtitle">Basic Details</h3>
                                <div className="_8PhoneRestaurantSignUp-inputGroup">
                                    <label htmlFor="_8PhoneRestaurantOwnerName" className="_8PhoneRestaurantSignUp-label">Owner's Full Name</label>
                                    <input className="_8PhoneRestaurantSignUp-input" onChange={(e) => setEnterOwnerFullName(e.target.value)} value={enterOwnerFullName} type="text" id="_8PhoneRestaurantOwnerName" />
                                    <p className="_7RestaurantError">{enterOwnerFullNameError}</p>
                                </div>
                                <div className="_8PhoneRestaurantSignUp-inputGroup">
                                    <label htmlFor="_8PhoneRestaurantName" className="_8PhoneRestaurantSignUp-label">Restaurant Name</label>
                                    <input className="_8PhoneRestaurantSignUp-input" onChange={(e) => setEnterRestaurantName(e.target.value)} value={enterRestaurantName} type="text" id="_8PhoneRestaurantName" />
                                    <p className="_7RestaurantError">{enterRestaurantNameError}</p>
                                </div>
                            </div>

                            <div className="_8PhoneRestaurantSignUp-inputGroup">
                                <h3 className="_8PhoneRestaurantSignUp-subtitle">Owner Contact Details</h3>
                                <div className="_8PhoneRestaurantSignUp-inputGroup">
                                    <label htmlFor="_8PhoneRestaurantOwnerEmail" className="_8PhoneRestaurantSignUp-label">Email address</label>
                                    <input className="_8PhoneRestaurantSignUp-input" onChange={(e) => setEnterEmailAddress(e.target.value)} value={enterEmailAddress} type="email" id="_8PhoneRestaurantOwnerEmail" />
                                    <p className="_7RestaurantError">{enterEmailAddressError}</p>
                                </div>
                                <div className="_8PhoneRestaurantSignUp-inputGroup">
                                    <label htmlFor="_8PhoneRestaurantMobile" className="_8PhoneRestaurantSignUp-label">Mobile Number</label>
                                    <input className="_8PhoneRestaurantSignUp-input" onChange={(e) => setEnterMobileNumber(e.target.value)} value={enterMobileNumber} type="number" id="_8PhoneRestaurantMobile" />
                                    <p className="_7RestaurantError">{enterMobileNumberError}</p>
                                </div>
                                <div className="_8PhoneRestaurantSignUp-inputGroup">
                                    <label htmlFor="_8PhoneRestaurantWhatsApp" className="_8PhoneRestaurantSignUp-label">WhatsApp Number</label>
                                    <input className="_8PhoneRestaurantSignUp-input" value={enterWhatsAppNumber} onChange={(e) => setEnterWhatsAppNumber(e.target.value)} type="number" id="_8PhoneRestaurantWhatsApp" />
                            ...
                            <div className="_8PhoneRestaurantSignUp-inputGroup">
                                <div className="working-days-header">
                                    <h3 className="_8PhoneRestaurantSignUp-subtitle">Working Days</h3>
                                    ...
                                    <div className="days-column">
                                        {Object.keys(selectedDays).slice(0, 4).map((day) => (
                                            <div key={day} className="day-checkbox">
                                                ...
                                                />
                                                <label className="_8PhoneRestaurantSignUp-label" htmlFor={day}>{day}</label>
                                            </div>
                                        ))}
                                    </div>
                                    <div className="days-column">
                            ...
                            <div className="_8PhoneRestaurantSignUp-inputGroup">
                                <h3 className="_8PhoneRestaurantSignUp-subtitle">Opening & Closing Time</h3>
                                <div style={{ display: "flex", justifyContent: "space-around" }}>
                                    <div className="_8PhoneRestaurantSignUp-inputGroup" style={{ width: "40%" }}>
                                        <label htmlFor="_8PhoneRestaurantOpeningTime" className="_8PhoneRestaurantSignUp-label">Opening Time</label>
                                        <input className="_8PhoneRestaurantSignUp-input" onChange={(e) => setSelectedOpeningTime(e.target.value)} value={selectedOpeningTime} type="time" id="_8PhoneRestaurantOpeningTime" />
                                        <p className="_7RestaurantError">{selectedOpeningTimeError}</p>
                                    </div>
                                    <div className="_8PhoneRestaurantSignUp-inputGroup" style={{ width: "40%" }}>
                                        <label htmlFor="_8PhoneRestaurantClosingTime" className="_8PhoneRestaurantSignUp-label">Closing Time</label>
                                        <input className="_8PhoneRestaurantSignUp-input" onChange={(e) => setSelectedClosingTime(e.target.value)} value={selectedClosingTime} type="time" id="_8PhoneRestaurantClosingTime" />
                    ...
                    <button onClick={submitRestaurantInfo} className="_8PhoneRestaurantSignUp-submitButton">
                                    Next
                                </button>
                    </>       
            );
            ...
            return (
                <>
                    <section className="_8PhoneRestaurantSignUp-step">
                        <h2 className="_8PhoneRestaurantSignUp-subtitle">Step 2: Restaurant Documents</h2>
                        ...
                        <div className="_8PhoneRestaurantSignUp-inputGroup">
                            <h3 className="_8PhoneRestaurantSignUp-subtitle">Enter PAN And GSTIN Details</h3>

                            <div className="_8PhoneRestaurantSignUp-inputGroup">
                                <label htmlFor="_8PhoneRestaurantPanDocuments" className="_8PhoneRestaurantSignUp-label">Enter Owner Pan Number</label>
                                <input
                                    className="_8PhoneRestaurantSignUp-input"
                                    onChange={(e) => setEnterOwnerPanNumber(e.target.value)}
                                    value={enterOwnerPanNumber}
                                    type="text"
                                    id="_8PhoneRestaurantPanDocuments"
                                />
                                <p className="_7RestaurantError">{enterOwnerPanNumberError}</p>
                            </div>

                            <div className="_8PhoneRestaurantSignUp-inputGroup">
                                <label htmlFor="_8PhoneRestaurantGstinDocuments" className="_8PhoneRestaurantSignUp-label">Enter GSTIN Number</label>
                                <input
                                    className="_8PhoneRestaurantSignUp-input"
                                    onChange={(e) => setEnterGstinNumber(e.target.value)}
                                    value={enterGstinNumber}
                                    type="text"
                                    id="_8PhoneRestaurantGstinDocuments"
                                />
                        ...
                        <div className="_8PhoneRestaurantSignUp-inputGroup">
                            <h3 className="_8PhoneRestaurantSignUp-subtitle">Official Bank Details</h3>
                            <p>Payment for Cook With Us will be credited here</p>

                            <div className="_8PhoneRestaurantSignUp-inputGroup">
                                <label htmlFor="_8PhoneRestaurantIfscCode" className="_8PhoneRestaurantSignUp-label">Enter IFSC Code</label>
                                <input
                                    className="_8PhoneRestaurantSignUp-input"
                                    onChange={(e) => setEnterIfscCode(e.target.value)}
                                    value={enterIfscCode}
                                    type="text"
                                    id="_8PhoneRestaurantIfscCode"
                                />
                                <p className="_7RestaurantError">{enterIfscCodeError}</p>
                            </div>

                            <div className="_8PhoneRestaurantSignUp-inputGroup">
                                <label htmlFor="_8PhoneRestaurantAccountNumber" className="_8PhoneRestaurantSignUp-label">Enter Account Number</label>
                                <input
                                    className="_8PhoneRestaurantSignUp-input"
                                    onChange={(e) => setEnterAccountNumber(e.target.value)}
                                    value={enterAccountNumber}
                                    type="number"
                                    id="_8PhoneRestaurantAccountNumber"
                                />
                        ...
                        <div className="_8PhoneRestaurantSignUp-inputGroup">
                            <h3 className="_8PhoneRestaurantSignUp-subtitle">FSSAI Certificate</h3>
                            <p>
                                <ul>
                            ...
                            <div className="_8PhoneRestaurantSignUp-inputGroup">
                                <label htmlFor="_8PhoneRestaurantFssaiNumber" className="_8PhoneRestaurantSignUp-label">FSSAI Certificate Number</label>
                                <input
                                    className="_8PhoneRestaurantSignUp-input"
                                    onChange={(e) => setEnterFssaiCertificate(e.target.value)}
                                    value={enterFssaiCertificate}
                                    type="text"
                                    id="_8PhoneRestaurantFssaiNumber"
                                />
                    ...
                    <button onClick={submitRestaurantDocs} className="_8PhoneRestaurantSignUp-submitButton">
                        Next
                    </button>
                </>
            );
            ...
            return (
                <>
                            <section className="_8PhoneRestaurantSignUp-step">
                                <h2 className="_8PhoneRestaurantSignUp-subtitle">Step 1: Restaurant Menu</h2>
                                <div className="_8PhoneRestaurantSignUp-inputGroup">
                                    <label htmlFor="_8PhoneRestaurantMenu" className="_8PhoneRestaurantSignUp-label">Upload Menu Here</label>
                                    <input className="_8PhoneRestaurantSignUp-input" type="file" id="_8PhoneRestaurantMenu" />
                                    <p className="_7RestaurantError">{uploadMenuError}</p>
                                </div>                                
                            </section>
                    <button onClick={submitRestaurantMenu} className="_8PhoneRestaurantSignUp-submitButton">
                                Next
                            </button>
                            </>
            );
            ...
            return (
                <>
                    <section className="_8PhoneRestaurantSignUp-step">
                        <h2 className="_8PhoneRestaurantSignUp-subtitle">Step 4: Restaurant Password</h2>
                            <div className="_8PhoneRestaurantSignUp-inputGroup">
                                <h3 className="_8PhoneRestaurantSignUp-subtitle">Enter Password</h3>

                                <div className="_8PhoneRestaurantSignUp-inputGroup">
                                    <label htmlFor="_8PhoneRestaurantPassword" className="_8PhoneRestaurantSignUp-label">Enter Password</label>
                                    <input className="_8PhoneRestaurantSignUp-input" onChange={(e) => setEnterPassword(e.target.value)} value={enterPassword} type="password" id="_8PhoneRestaurantPassword" />
                                    <p className="_7RestaurantError">{enterPasswordError}</p>
                                </div>

                                <div className="_8PhoneRestaurantSignUp-inputGroup">
                                    <label htmlFor="_8PhoneRestaurantConfirmPassword" className="_8PhoneRestaurantSignUp-label">Enter Confirm Password</label>
                                    <input className="_8PhoneRestaurantSignUp-input" onChange={(e) => setEnterConfirmPassword(e.target.value)} value={enterConfirmPassword} type="password" id="_8PhoneRestaurantConfirmPassword" />
                                    <p className="_7RestaurantError">{enterConfirmPasswordError}</p>
                                </div>
                            </div>
                    </section>
                    <button onClick={submitRestaurantPass} className="_8PhoneRestaurantSignUp-submitButton">
                        Next
                    </button>
                </>
            );
    ...
    return (
        <>
            <div className="_8PhoneRestaurantSignUp-webcrumbs">
                <div className="_8PhoneRestaurantSignUp-container">
                    <form>
                        <h1 className="_8PhoneRestaurantSignUp-title">Register Your Restaurant</h1>
                        {renderStepDetails()}  
                    </form>
                </div>
            </div>  
            {openSelectCategory &&
                (
                    <>
                        ...
                        <div className="_7sideBarSelectCategoryLayout" style={{width:"auto"} }>
