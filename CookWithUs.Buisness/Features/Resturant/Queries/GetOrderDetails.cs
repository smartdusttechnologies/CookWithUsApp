...
namespace CookWithUs.Buisness.Features.Resturant.Queries
{
    ...
    {
        public class Command : IRequest<OrderModel>
        {
        ...
        public class Handler : IRequestHandler<Command, OrderModel>
        {
            ...
            Task<OrderModel> IRequestHandler<Command, OrderModel>.Handle(Command request, CancellationToken cancellationToken)
            {
                return Task.FromResult(_restaurant.GetOrderDetails(request.orderId));
            }
        }
    }
}
