...
namespace CookWithUs.Buisness.Features.Rider
{
    public class SendOrderRequest
    {
        ...
        {
            public SendOrderRequestModel allRiderDetails { get; set; }
            public Command(SendOrderRequestModel riderDetails)
            {
                allRiderDetails = riderDetails;
            }
        }
        ...
        public class Handler : IRequestHandler<Command, RequestResult<bool>>
        {
            ...
            {
                return Task.FromResult(_rider.SendRequestOfRider(request.allRiderDetails));
            }
        }
    }
}
