...
{
    public static class RiderSetStatus
    {
        public class Command : IRequest<RequestResult<bool>>
        {
            public SetOrderStatusModel details { get; set; }


            public Command(SetOrderStatusModel Details)
            {
                details = Details;
            }
        }
        ...
        public class Handler : IRequestHandler<Command, RequestResult<bool>>
        {
            ...
            {
                return Task.FromResult(_rider.SetRiderStatus(request.details));
            }
        }
    }
}
